 ...
 *
 * If you have any questions related to code, you can drop them in my Twitter DM @KishanPatel_dev
 * or in my email at kishan.patel.tech.dev@gmail.com
 *
...
const user = 'Kishan-Patel-dev';
const repo = 'text-to-handwriting';
